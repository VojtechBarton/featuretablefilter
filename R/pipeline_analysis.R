...
#' Run sparsity elbow detection (diagnostic only)
#'
#' Wrapper around identify_sparsity_elbow() for diagnostic purposes.
#'
#' @param table Feature table (data.frame)
#' @param method Elbow detection method: "kneedle", "max_derivative", or "second_derivative"
#' @param verbose Logical. Print progress messages?
#'
#' @return Result from identify_sparsity_elbow()
...
#' Run depth-sparsity outlier analysis (diagnostic only)
#'
#' Wrapper around analyze_depth_sparsity() for diagnostic purposes.
#'
#' @param table Feature table (data.frame)
...
#' @param verbose Logical. Print progress messages?
#'
#' @return Result from analyze_depth_sparsity()
...
#' Run scree/saturation analysis
#'
#' Wrapper around compute_scree() for comprehensive filtering threshold exploration.
#'
#' @param table Original feature table (data.frame)
#' @param type Scree sweep type: "mad_multiplier", "absolute_feature", "relative_feature", or "custom"
#' @param n_steps Number of steps for the sweep
#' @param thresholds Custom thresholds vector (for type = "custom")
#' @param verbose Logical. Print progress messages?
#'
#' @return Result from compute_scree()
...
#'
#' Helper function to get basic statistics about a feature table.
#'
#' @param table Feature table (data.frame)
#'
#' @return A list with features, samples, and reads counts
